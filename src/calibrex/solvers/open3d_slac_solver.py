...
class Open3DSLACInputs:
    """Open3D SLAC input summary extracted from a Calibrex dataset."""
...
class Open3DSLACSolver(SolverAdapter):
    ...
    def solve(
        ...
        """Inspect Open3D SLAC readiness and return Calibrex metrics."""
        ...
        warnings: list[str] = []
        if not available:
            warnings.append("install calibrex[open3d] to execute Open3D SLAC")
