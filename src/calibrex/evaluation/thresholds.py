...
DEFAULT_THRESHOLDS: dict[str, MetricThreshold] = {
    ...
    "tum_joint_replication_window_count": MetricThreshold(
        metric="tum_joint_replication_window_count",
        pass_value=3.0,
        warn_value=2.0,
        direction="higher_is_better",
        unit="windows",
    ),
    "tum_joint_replication_converged_fraction": MetricThreshold(
        metric="tum_joint_replication_converged_fraction",
        pass_value=1.0,
        warn_value=0.67,
        direction="higher_is_better",
    ),
    "tum_joint_replication_reference_pass_fraction": MetricThreshold(
        metric="tum_joint_replication_reference_pass_fraction",
        pass_value=1.0,
        warn_value=0.67,
        direction="higher_is_better",
    ),
    "tum_joint_replication_depth_scale_range_percent": MetricThreshold(
        metric="tum_joint_replication_depth_scale_range_percent",
        pass_value=2.0,
        warn_value=5.0,
        unit="percent",
    ),
    "tum_joint_replication_depth_bias_range_m": MetricThreshold(
        metric="tum_joint_replication_depth_bias_range_m",
        pass_value=0.03,
        warn_value=0.06,
        unit="m",
    ),
    "tum_joint_cross_window_max_holdout_delta_rmse_m": MetricThreshold(
        metric="tum_joint_cross_window_max_holdout_delta_rmse_m",
        pass_value=0.005,
        warn_value=0.015,
        unit="m",
    ),
    "tum_joint_cross_window_nondegrading_fraction": MetricThreshold(
        metric="tum_joint_cross_window_nondegrading_fraction",
        pass_value=1.0,
        warn_value=0.5,
        direction="higher_is_better",
    ),
