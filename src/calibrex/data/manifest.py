...
DATASET_MANIFEST_SCHEMA_VERSION: Literal["calibrex.dataset_manifest/v0.1"] = (
    "calibrex.dataset_manifest/v0.1"
)
...
class DatasetManifest(StrictModel):
    ...
    schema_version: Literal["calibrex.dataset_manifest/v0.1"] = DATASET_MANIFEST_SCHEMA_VERSION
    name: str
