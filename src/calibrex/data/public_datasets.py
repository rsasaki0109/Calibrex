...
class PublicDatasetEntry(BaseModel):
    """One public dataset entry known to Calibrex examples."""
    ...
    license_note: str
    calibrex_manifest: str | None = None
    calibrex_config: str | None = None
...
class PublicDatasetCatalog(BaseModel):
    ...
    schema_version: str = "calibrex.public_datasets/v0.1"
