...
from calibrex.core.result import CalibrationResult, EstimateRole, StrictModel, TransformResult

TRANSFORMS_SCHEMA_VERSION: Literal["calibrex.transforms/v0.1"] = (
...
class TransformArtifact(StrictModel):
    ...
    schema_version: Literal["calibrex.transforms/v0.1"] = TRANSFORMS_SCHEMA_VERSION
    run: ReportRunInfo
