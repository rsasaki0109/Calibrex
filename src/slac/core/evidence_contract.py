...
from slac.core.assessment import AssessmentArtifact, AssessmentPolicy
from slac.core.report_artifacts import EvidenceProtocolItem, ReportRunInfo
from slac.core.result import StrictModel

PROTOCOL_SCHEMA_VERSION: Literal["slac.protocol/v0.1"] = "slac.protocol/v0.1"
POLICY_SCHEMA_VERSION: Literal["slac.policy/v0.1"] = "slac.policy/v0.1"
...
class ProtocolArtifact(StrictModel):
    ...
    schema_version: Literal["slac.protocol/v0.1"] = PROTOCOL_SCHEMA_VERSION
    run: ReportRunInfo
...
class PolicyArtifact(StrictModel):
    ...
    schema_version: Literal["slac.policy/v0.1"] = POLICY_SCHEMA_VERSION
    run: ReportRunInfo
