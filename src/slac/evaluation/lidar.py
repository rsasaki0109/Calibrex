...
from slac.core.geometry import SE3, QuaternionXYZW, Vector3
from slac.core.report_artifacts import EvidenceCaseItem
from slac.core.result import Grade, MetricResult
...
def build_rig_point_to_plane_observations(
    *,
    ...
    ``source_records`` provide the voxel-plane map expressed in the world frame.
    Each target point ``p_target`` is matched to its nearest source plane after
    applying ``T_world_source * T_source_target`` when per-point
