...
| Hand-eye and robot-world/hand-eye calibration | Five native `AX=XB` baselines plus independent Shah and Li-Wang-Wu simultaneous `AX=YB`; ETHZ common absolute-pose holdout and 24 controls per method |
