...
In slac, SLAC means simultaneous localization and calibration as an
...
slac should not hard-code one SLAC algorithm into the core. Instead, it
...
- [M-LOAM](https://arxiv.org/abs/2010.14294): online multi-LiDAR odometry,
  mapping, and extrinsic calibration. It informs a future `slac online`
  design, but not the first offline MVP.
- [Koide et al. ICRA 2023](https://arxiv.org/abs/2302.05094): general,
  single-shot, targetless, automatic LiDAR-camera calibration. slac should
